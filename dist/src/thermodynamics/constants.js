...
export class TemperatureNormalizationEngine {
    ...
    toCelsius(value) {
        const kelvin = Math.max(THERMODYNAMIC_CONSTANTS.PLANETARY_TEMP_MIN_K, Math.min(THERMODYNAMIC_CONSTANTS.PLANETARY_TEMP_MAX_K, value + THERMODYNAMIC_CONSTANTS.ZERO_CELSIUS_IN_KELVIN));
        return kelvin - THERMODYNAMIC_CONSTANTS.ZERO_CELSIUS_IN_KELVIN;
    }
    getArrheniusScalar(tempK, activationEnergyJoulePerMol) {
