...
export class CyclePOD extends ThermodynamicStructure {
    ...
    transfer(sourceReservoir, targetReservoir, customRate) {
...
export class EarthPOD extends ThermodynamicStructure {
    ...
    carbonCycle = new CarbonCycle();
    waterCycle = new WaterCycle();
    nitrogenCycle = new NitrogenCycle();
    phosphorusCycle = new PhosphorusCycle();
    constructor() {
        super("Earth");
    ...
    getStateVector() {
        ...
        const vec = new ThermodynamicStateVector({
            ...
            clone: (overrides) => new ThermodynamicStateVector({ ...vec.toObject(), ...overrides }),
            ...
            getStock: (k) => k === undefined ? (vec.stocks instanceof Map ? Object.fromEntries(vec.stocks) : vec.stocks) : (vec.stocks instanceof Map ? (vec.stocks.get(k) ?? 0) : (vec.stocks[k] ?? 0)),
