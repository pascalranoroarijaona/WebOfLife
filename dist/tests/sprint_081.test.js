...
import { assertPentagonalNeighborStringElements, validatePentagonalNeighbors, H3AdjacencyValidator, SpatialFluxMonad, } from '../src/spatial/h3_adjacency.js';
describe('Sprint 081: assertPentagonalNeighborStringElements & Spatial Adjacency Invariants', () => {
    ...
    it('TC-081-01: passes without error for valid 5-element string neighbor arrays', () => {
        ...
        const validated = validPentagonNeighbors;
    ...
    it('TC-081-07: throws TypeError when input collection is not an array', () => {
        assert.throws(() => {
            assertPentagonalNeighborStringElements(null);
        }, {
            name: 'TypeError',
            message: 'Pentagonal neighbor collection must be an array, received null',
        });
        assert.throws(() => {
            assertPentagonalNeighborStringElements(undefined);
        }, {
            name: 'TypeError',
            message: 'Pentagonal neighbor collection must be an array, received undefined',
        });
        assert.throws(() => {
            assertPentagonalNeighborStringElements('85283473fffffff');
        }, {
            name: 'TypeError',
