...
describe('Sprint 037: H3_CANONICAL_INDEX_PATTERN & Spatial Validation Suite', () => {
    ...
    it('executeAdvectiveTransfer obeys mass conservation invariant (Delta M_total = 0)', () => {
        ...
        const initialTotalMass = initialStocksSource.waterKg + initialStocksSource.carbonKg + initialStocksSource.mineralKg + initialStocksSource.oxygenKg +
            initialStocksTarget.waterKg + initialStocksTarget.carbonKg + initialStocksTarget.mineralKg + initialStocksTarget.oxygenKg;
        const finalTotalMass = result.source.getStocks().waterKg + result.source.getStocks().carbonKg + result.source.getStocks().mineralKg + result.source.getStocks().oxygenKg +
