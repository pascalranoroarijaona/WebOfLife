...
describe('Sprint 006 - Biogeochemical CyclePOD Instances', () => {
    it('Carbon Cycle maintains strict mass conservation across 1,000 steps', () => {
        ...
        let initialTotal = 0;
        for (const val of initialStocks.values())
            initialTotal += val;
        for (let i = 0; i < 1000; i++) {
            carbon.step(1.0, 1.74e17);
        }
        let finalTotal = 0;
        for (const val of carbon.getStocks().values())
            finalTotal += val;
    ...
    it('Water Cycle maintains strict mass conservation across 1,000 steps', () => {
        ...
        let initialTotal = 0;
        for (const val of water.getStocks().values())
            initialTotal += val;
        for (let i = 0; i < 1000; i++) {
    ...
    it('Nitrogen Cycle maintains strict mass conservation across 1,000 steps', () => {
        ...
        let initialTotal = 0;
        for (const val of nitrogen.getStocks().values())
            initialTotal += val;
        for (let i = 0; i < 1000; i++) {
    ...
    it('Phosphorus Cycle maintains strict mass conservation across 1,000 steps', () => {
        ...
        let initialTotal = 0;
        for (const val of phosphorus.getStocks().values())
            initialTotal += val;
        for (let i = 0; i < 1000; i++) {
