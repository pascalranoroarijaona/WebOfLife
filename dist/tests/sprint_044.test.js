...
import { STP_CONSTANTS, computeAugustRocheMagnusSatVaporPressure, } from '../src/thermodynamics/constants.js';
import { isValidH3Index, getH3Resolution, getH3CellAreaM2, createDefaultH3CellThermodynamicState, SpatialMonad, } from '../src/spatial/h3_state_tensor.js';
describe('Sprint 044: Baseline STP H3 Cell Thermodynamic State Tensor', () => {
    ...
    it('creates default baseline STP state satisfying First Law mass conservation', () => {
        ...
        const reconstructedAtmMassKg = state.atmosphere.nitrogenMoles * STP_CONSTANTS.MOLAR_MASS_N2 +
    ...
    it('integrates seamlessly with SpatialMonad functor and bind operations', () => {
        ...
        const perturbedMonad = monad.flatMap((s) => {
        ...
        const perturbedVal = perturbedMonad.value;
