...
import { CANONICAL_H3_REGEX, matchesCanonicalH3Pattern, isValidH3Index, SpatialTransferMonad, H3Grid } from '../src/spatial/h3_grid.js';
...
describe('Sprint 038: Canonical H3 Pattern Matching Engine', () => {
    describe('CANONICAL_H3_REGEX and matchesCanonicalH3Pattern validation', () => {
        ...
        it('should gracefully handle non-string runtime types', () => {
            assert.strictEqual(matchesCanonicalH3Pattern(undefined), false);
            assert.strictEqual(matchesCanonicalH3Pattern(null), false);
            assert.strictEqual(matchesCanonicalH3Pattern(12345), false);
            assert.strictEqual(matchesCanonicalH3Pattern({}), false);
        });
