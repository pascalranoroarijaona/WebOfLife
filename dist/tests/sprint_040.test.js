...
import { H3_GLOBAL_CANONICAL_INDEX_PATTERN, extractCanonicalH3Tokens, H3Grid, SpatialPartitionMonad } from '../src/spatial/h3_grid.js';
    ...
    describe('Bulk Extraction & Canonical Normalization', () => {
      ...
      `;
        ...
        it('should handle empty or invalid input gracefully', () => {
            ...
            assert.deepStrictEqual(extractCanonicalH3Tokens(null), []);
            assert.deepStrictEqual(extractCanonicalH3Tokens(undefined), []);
