...
describe('Sprint 031: H3 Grid Validator & Spatial Monad Execution Tests', () => {
    ...
    it('should reject invalid edge cases: empty strings, non-hex characters, and non-string types', () => {
        ...
        assert.strictEqual(H3GridValidator.isValidHexIndex(null), false);
        assert.strictEqual(H3GridValidator.isValidHexIndex(undefined), false);
        assert.strictEqual(H3GridValidator.isValidHexIndex(123456), false);
    });
