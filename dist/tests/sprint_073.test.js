...
import { assertBoundaryEndpointTolerance, computeSphericalAngularDistance, normalizeSphericalCoords, validateSharedEdgeTopologicalAlignment, BoundaryEndpointToleranceExceededError, DEFAULT_BOUNDARY_ANGULAR_TOLERANCE_RAD, HIGH_PRECISION_BOUNDARY_ANGULAR_TOLERANCE_RAD, EARTH_MEAN_RADIUS_METERS, H3AdjacencyGraph, SpatialFluxMonad, } from '../src/spatial/h3_adjacency.js';
describe('Sprint 073: Spherical Angular Tolerance & Boundary Assertions', () => {
    ...
    describe('Central Angular Distance Computation', () => {
        ...
        it('handles antimeridian boundary correctly without spurious divergence', () => {
            ...
            const p1 = [0.0, 3.141592];
            const p2 = [0.0, -3.141592];
    ...
    describe('Adjacency Graph & Thermodynamic Conservation Integration', () => {
        ...
        it('enforces First Law of Thermodynamics across verified boundary interface', () => {
            ...
            const flux = graph.computeInterfaceTransport('cell_A', 'cell_B', 0.5, // 0.5 m/s normal advection
