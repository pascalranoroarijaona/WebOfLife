...
import { assertValidLatitudeDegrees, calculateGeodesicDistance, calculateCoriolisParameter, calculateTOAInsolation, SpatialStateMonad, H3AdjacencyResolver, computePairwiseDiffusiveTransfer, } from "../src/spatial/h3_adjacency.js";
import { createGeodesicCoordinate, degreesToRadians, syntheticH3Index, } from "../src/spatial/h3_grid.js";
import { EARTH_ANGULAR_VELOCITY_RAD_S, SOLAR_CONSTANT_W_M2, } from "../src/thermodynamics/constants.js";
...
describe("Sprint 053: Subsystem Geodesic Integration Checks", () => {
    it("computes orthodromic distance across poles and verifies boundary guards", () => {
        const southPole = { latDeg: -90.0, lonDeg: 0.0 };
        const northPole = { latDeg: 90.0, lonDeg: 0.0 };
    ...
    it("maintains strict thermodynamic conservation during diffusive exchange", () => {
        ...
        const { exchangeAtoB, conserved } = computePairwiseDiffusiveTransfer(coordA, stateA, coordB, stateB, 5000.0, 0.01, 0.005, 60.0);
        ...
        assert.throws(() => {
            computePairwiseDiffusiveTransfer({ latDeg: -100.0, lonDeg: 0 }, stateA, coordB, stateB, 5000.0, 0.01, 0.005, 60.0);
        }, RangeError);
    });
