...
import { ThermodynamicViolationError, STANDARD_AMBIENT_TEMPERATURE_K } from '../src/thermodynamics/types.js';
describe('Sprint 034: Thermodynamic State Vector Non-Negative Entropy Assertion', () => {
    const validator = new StateValidator();
    const createMockVector = (entropy, entropyGenerationRate) => ({
        timestamp: 0,
        internalEnergy: 1e6,
