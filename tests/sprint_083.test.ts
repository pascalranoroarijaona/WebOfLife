...
describe('Sprint 083: Pentagon Directional Topology Specification (RFC-083)', () => {
  it('should create valid pentagon topology with 5 present directions and 1 omitted direction', () => {
    ...
    const unionSet = new Set<H3Direction>([...topology.presentDirections, topology.omittedDirection]);
  ...
  it('should reject invalid topology with duplicate or incorrect direction counts', () => {
    // 4 directions only
    const invalidUnderflow: PentagonDirectionalTopology = {
    ...
    const invalidHex: PentagonDirectionalTopology = {
    ...
    const invalidOverlap: PentagonDirectionalTopology = {
    ...
    const invalidDuplicates: PentagonDirectionalTopology = {
  ...
  it('should enforce First Law of Thermodynamics: throw error on flux across omittedDirection', () => {
    ...
    const validInbound: DirectionalFlux[] = [
      { direction: 1, delta: sampleStock },
    ];

    const invalidOutbound: DirectionalFlux[] = [
    ...
    const invalidInbound: DirectionalFlux[] = [
  ...
  it('should conserve mass and calculate accurate net deltas across active directions', () => {
    ...
    const inboundFluxes: DirectionalFlux[] = [
    ...
    const outboundFluxes: DirectionalFlux[] = [
