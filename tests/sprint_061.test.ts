...
class MockStructure extends ThermodynamicStructure {
  constructor(name: string, private expectedDeltas: Record<string, number>) {
    super(name);
  }

  public calculateFluxDerivedDeltas(_previousState: StateVector, _deltaTime: number): Record<string, number> {
