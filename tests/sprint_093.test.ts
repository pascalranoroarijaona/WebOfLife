...
import {
  ...
  getApertureRotationDescriptor,
  H3AdjacencyService,
  H3_APERTURE_ROTATION_ANGLE_RAD,
  H3_APERTURE_ROTATION_ANGLE_DEG,
  MIN_H3_RESOLUTION,
  MAX_H3_RESOLUTION
...
describe('Sprint 093 - Aperture Rotation Sequence Resolution', () => {
  ...
  describe('SpatialFluxMonad & Coordinate Transformation', () => {
    ...
    it('should align flux vectors across res 0 -> 1 with exact norm preservation', () => {
      ...
      const inputFlux: FluxVector2D = { jX: 1.0, jY: 0.0 };
    ...
    it('should apply zero rotation when both resolutions share the same aperture parity (res 0 -> 2)', () => {
      ...
      const inputFlux: FluxVector2D = { jX: 3.5, jY: -4.2 };
    ...
    it('should guarantee 100% mass and enthalpy conservation across boundary stock transfers', () => {
      ...
      const sourceStocks: ConservedStocks = {
        carbonMol: 1000,
        waterMol: 5000,
        mineralsMol: 250,
        oxygenMol: 800,
      ...
      const targetStocks: ConservedStocks = {
        carbonMol: 200,
        waterMol: 1000,
        mineralsMol: 50,
        oxygenMol: 150,
      ...
      const transfer: ConservedStocks = {
        carbonMol: 50,
        waterMol: 200,
        mineralsMol: 15,
        oxygenMol: 40,
    ...
    it('should reject transfers exceeding source availability', () => {
      ...
      const invalidTransfer: ConservedStocks = {
