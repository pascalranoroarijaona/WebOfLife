...
import { isValidH3Index, assertValidH3Index, H3_REGEX } from '../src/spatial/h3_grid.js';
...
describe('Sprint 008 - H3 Index Regex and Character Set Validation', () => {
  ...
  it('should reject empty, null, or non-string inputs', () => {
    ...
    assert.strictEqual(isValidH3Index(null as any), false);
    assert.strictEqual(isValidH3Index(undefined as any), false);
    assert.strictEqual(isValidH3Index(123456789012345 as any), false);
  });
