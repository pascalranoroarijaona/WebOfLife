...
import { IFlowRateVector } from '../src/thermodynamics/types.js';
...
describe('Sprint 056: Thermodynamic State Vector Stock Conservation Delta Calculator', () => {
    it('should calculate standard inflow/outflow integration and linear scaling with dt', () => {
        ...
        const inflows = new Map<string, number>([['source_1', 5.0]]);
        const outflows = new Map<string, number>([['sink_1', 2.0]]);
        
        const vector: IFlowRateVector = {
            element: 'carbon',
            inflows,
            outflows
        };
