...
import { 
  ...
  stepThermodynamicMonad 
} from '../src/thermodynamics/thermodynamic_monad_process.js';
...
describe('Sprint 20: Thermodynamic State Vector & Monad Integration (RFC 020)', () => {
  ...
  it('should maintain Gouy-Stodola consistency (I = T_0 * S_gen)', () => {
    ...
    assert.strictEqual(
      result.state.exergyDestructionRate,
      STANDARD_AMBIENT_TEMPERATURE_K * result.state.entropyGenerationRate
    );
  });
