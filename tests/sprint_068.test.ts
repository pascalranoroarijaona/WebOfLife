...
describe('Sprint 068: Thermodynamic State Vector Inventory Discrepancy Evaluator', () => {
  ...
  it('should detect state vectors exceeding tolerance bounds per element', () => {
    ...
    const carbonDisc = discrepancies.find((d: any) => d.element === 'carbon' || d.stockKey === 'carbon');
    const nitrogenDisc = discrepancies.find((d: any) => d.element === 'nitrogen' || d.stockKey === 'nitrogen');
  ...
  it('should handle custom tolerance overrides correctly', () => {
    ...
    const strictCarbon = strictDiscs.find((d: any) => d.element === 'carbon' || d.stockKey === 'carbon');
    ...
    const looseCarbon = looseDiscs.find((d: any) => d.element === 'carbon' || d.stockKey === 'carbon');
